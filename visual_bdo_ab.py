...
def plot_losses():
    ...
    colors = ['#2986cc', '#9f2f2f']  # Blue, orange, green, red
    markers = ['o', 'D']  # Circle, square, triangle, diamond
    linestyles = ['-', '-']
    
    for i, r in enumerate(exp):
        filename = f'{path}/{loss_type}_loss_{dataset}_{id}_{r_ema}_{r}.npy'
    ...
    output_file = f'{path}/{dataset}_{loss_type}_{id}_ab_comparison.pdf'
